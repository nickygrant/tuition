# EC5221 Econometric Time Series Analysis — Week 1 (2021)

**Course:** EC5221, University of St Andrews, postgraduate MSc
**Author:** Dr Nicky Grant
**Key topics:** Stationarity, white noise, ACF, ARMA(p,q), MA(q), AR(p), Wold decomposition, moment conditions, stationarity conditions
...
- 0.25 y_T-1^s =0.5y_T-2 ^s+\varepsilon_T-1^s
...
- mydef*[width=5.5in]Strictly Stationary Process A process \Z_t\ is strictly stationary if for all t_1, t_k T (for any positive integer k) the joint density of (Z_t_1+,...,Z_t_k+)' is invariant to .
...
- 10pt Mean and/or (co-) variance of Z_t is not constant over time
 \pause10pt 
...
- 15pt Correlations a function of 'gap' k, not time
